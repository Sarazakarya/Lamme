...
export default function Home() {
  return (
    <div className="flex flex-wrap items-center justify-between gap-8 px-4 overflow-x-hidden">
      {/* Hero Section */}
      <div className="flex flex-col gap-5 w-full md:flex-1 min-w-[300px]">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight max-w-2xl leading-none">
          <span className="bg-gradient-to-b from-green-400 to-green-900 text-transparent bg-clip-text block opacity-80">
            BETTER DESIGN
          </span>
          <span className="bg-gradient-to-b from-gray-300 to-gray-400 text-transparent bg-clip-text block opacity-80my-1">
            FOR YOUR DIGITAL
          </span>{" "}
          <span className="bg-gradient-to-b from-gray-200 to-gray-300 text-transparent bg-clip-text opacity-90">
            PRODUCTS
          </span>
        </h1>
